...
def create_generator():
    ...
    generator.add(Dense(units=512*16*16,input_dim=INPUT_SIZE))
    ...
    generator.add(Conv2DTranspose(32, 4, strides=2, activation='relu', padding='same'))
    generator.add(BatchNormalization(momentum=0.1, epsilon=1e-05))
...
def create_discriminator():
    ...
    discriminator.add(Conv2D(64, kernel_size = 4, strides = 2, padding = 'same', input_shape=(256,256,3)))
